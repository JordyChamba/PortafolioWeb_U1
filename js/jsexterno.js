...
function evaluarOperacion(operacion) {
  ...
  if (isNaN(num1) || isNaN(num2)) {
    document.getElementById("id_resultado").innerText =
...
function fundamentosJS() {
  /*Tipos de variables*/
  var nombre = "Jordy"; // antigua, ya es considerada obsoleta
  let apellido = "Chamba"; // variables cambiantes
  let apellido2 = 30; // aplica tipado dinamico, no se necesita declarar el tipo de dato
  apellido2 = "Pedro"; // reasignacion de variable
